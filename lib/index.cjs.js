...
var emojione$1 = _interopDefault(require('emojione'));
...
var Emoji = function Emoji(_ref) {
  ...
  var shortName = emojione$1.toShort(decoratedText);
  var emojiDisplay = null;

  if (useNativeArt === true) {
    emojiDisplay = React__default.createElement("span", {
      title: emojione$1.toShort(decoratedText)
    }, props.children);
  } else {
    // short name to image url code steal from emojione source codes
    var shortNameForImage = emojione$1.emojioneList[shortName].uc_base;
...
var newEmojiListWithOutPriorityList = function newEmojiListWithOutPriorityList(priorityList) {
  ...
  for (var key in emojione$1.emojioneList) {
    ...
    list[key] = emojione$1.emojioneList[key].unicode;
  }
...
var convertShortNameToUnicode = function convertShortNameToUnicode(unicode) {
  return emojione.shortnameToUnicode(unicode);
};
  ...
  _createClass(Entry, [{
    ...
    value: function render() {
      ...
      if (useNativeArt === true) {
        ...
        var shortNameForImage = emojione$1.emojioneList[this.props.emoji].uc_base;
        var fullImagePath = "".concat(imagePath).concat(shortNameForImage, ".").concat(imageType).concat(cacheBustParam);
        emojiDisplay = React__default.createElement("img", {
          src: fullImagePath,
...
function (_Component) {
  ...
  _createClass(EmojiSuggestions, [{
    ...
    value: function render() {
      ...
      return React__default.createElement("div", _extends({}, restProps, {
...
var defaultEmojiGroups = [{
  title: 'People',
  icon: React__default.createElement(FaSmileO, {
    style: {
      verticalAlign: ''
    }
  }),
  ...
  title: 'Nature',
  icon: React__default.createElement(FaPaw, {
    style: {
      verticalAlign: ''
    }
  }),
  ...
  title: 'Food & Drink',
  icon: React__default.createElement(FaCutlery, {
    style: {
      verticalAlign: ''
    }
  }),
  ...
  title: 'Activity',
  icon: React__default.createElement(FaFutbolO, {
    style: {
      verticalAlign: ''
    }
  }),
  ...
  title: 'Travel & Places',
  icon: React__default.createElement(FaPlane, {
    style: {
      verticalAlign: ''
    }
  }),
  ...
  title: 'Objects',
  icon: React__default.createElement(FaBell, {
    style: {
      verticalAlign: ''
    }
  }),
  ...
  title: 'Symbols',
  icon: React__default.createElement(FaHeart, {
    style: {
      verticalAlign: ''
    }
  }),
  ...
  title: 'Flags',
  icon: React__default.createElement(FaFlag, {
    style: {
      verticalAlign: ''
    }
  }),
  ...
  _createClass(Entry, [{
    ...
    value: function render() {
      ...
      if (useNativeArt === true) {
        ...
        // short name to image url code steal from emojione source code
        var shortNameForImage = emojione$1.emojioneList[emoji].uc_base;
        var fullImagePath = "".concat(imagePath).concat(shortNameForImage, ".").concat(imageType).concat(cacheBustParam);
        emojiDisplay = React__default.createElement("img", {
          src: fullImagePath,
...
function (_Component) {
  ...
  function Group() {
    ...
    _defineProperty(_assertThisInitialized(_this), "renderCategory", function (category) {
      ...
      return Object.keys(categoryEmojis).map(function (key) {
        ...
        }, isActive && React__default.createElement(Entry$1, {
  ...
  _createClass(Group, [{
    ...
    value: function render() {
      ...
      }, group.title), React__default.createElement("ul", {
...
function (_Component) {
  ...
  _createClass(Groups, [{
    ...
    value: function render() {
      ...
      }, React__default.createElement(reactCustomScrollbars.Scrollbars, {
...
var Nav = function Nav(_ref) {
  ...
  return React__default.createElement("ul", {
    ...
    }, React__default.createElement(Entry$2, {
      theme: theme,
      groupIndex: index,
  ...
  _createClass(ToneSelect, [{
    ...
    value: function render() {
      ...
      return React__default.createElement("div", {
        ...
        }, React__default.createElement(Entry$1, {
          emoji: emoji,
          theme: theme,
          imagePath: imagePath,
          imageType: imageType,
...
function (_Component) {
  ...
  function Popover() {
    ...
    _defineProperty(_assertThisInitialized(_this), "renderToneSelect", function () {
      if (_this.state.showToneSelect) {
        ...
        return React__default.createElement(ToneSelect, {
          theme: theme,
          bounds: bounds,
  ...
  _createClass(Popover, [{
    ...
    value: function render() {
      ...
      }, groups[activeGroup].title), React__default.createElement(Groups, {
        theme: theme,
        groups: groups,
        emojis: emojis,
        imagePath: imagePath,
  ...
  _createClass(EmojiSelect, [{
    ...
    value: function render() {
      ...
      return React__default.createElement("div", {
        ...
        type: "button"
      }, selectButtonContent), React__default.createElement(Popover, {
        cacheBustParam: cacheBustParam,
        imagePath: imagePath,
        imageType: imageType,
        theme: theme,
...
var unicodeRegex = new RegExp(emojione$1.unicodeRegexp, 'g');
...
var unicodeRegex$1 = new RegExp(emojione$1.unicodeRegexp, 'g');
/*
...
var defaultCacheBustParam = '?v=4.5.0'; // TODO activate/deactivate different the conversion or search part
...
var index = (function () {
  ...
  var DecoratedEmojiSuggestions = function DecoratedEmojiSuggestions(props) {
    return React__default.createElement(EmojiSuggestions, _extends({}, props, suggestionsProps));
  };

  var DecoratedEmojiSelect = function DecoratedEmojiSelect(props) {
    return React__default.createElement(EmojiSelect, _extends({}, props, selectProps));
  };
  ...
  var DecoratedEmojiSuggestionsPortal = function DecoratedEmojiSuggestionsPortal(props) {
    return React__default.createElement(EmojiSuggestionsPortal, _extends({}, props, {
      store: store
    }));
  };
