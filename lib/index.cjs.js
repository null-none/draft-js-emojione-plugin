...
var draftJs$1 = require('draft-js');
...
var addEmoji = function addEmoji(editorState, emojiShortName) {
  ...
  return draftJs$1.EditorState.forceSelection(newEditorState, newEditorState.getCurrentContent().getSelectionAfter());
};
  ...
  return {
    ...
    onChange: function onChange(editorState) {
      ...
      if (!newEditorState.getCurrentContent().equals(editorState.getCurrentContent())) {
        ...
        // the contenteditable.
        newEditorState = draftJs$1.EditorState.forceSelection(newEditorState, newEditorState.getSelection());
      }
